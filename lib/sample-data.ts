...
export function initializeSampleData() {
  ...
  // Initialize pets
  if (!localStorage.getItem("petpal_pets")) {
    localStorage.setItem("petpal_pets", JSON.stringify(samplePets))
  }

  // Initialize applications
  if (!localStorage.getItem("petpal_applications")) {
    localStorage.setItem("petpal_applications", JSON.stringify(sampleApplications))
  }

  // Initialize messages
  if (!localStorage.getItem("petpal_messages")) {
    localStorage.setItem("petpal_messages", JSON.stringify(sampleMessages))
  }

  // Initialize notifications
  if (!localStorage.getItem("petpal_notifications")) {
    localStorage.setItem("petpal_notifications", JSON.stringify(sampleNotifications))
  }

  // Initialize care entries
  if (!localStorage.getItem("petpal_care_entries")) {
    localStorage.setItem("petpal_care_entries", JSON.stringify(sampleCareEntries))
  }

  // Initialize reminders
  if (!localStorage.getItem("petpal_reminders")) {
    localStorage.setItem("petpal_reminders", JSON.stringify(sampleReminders))
  }
  ...
  if (!localStorage.getItem("petpal_adopted_pets")) {
    localStorage.setItem("petpal_adopted_pets", JSON.stringify(adoptedPets))
  }

  // Initialize favorites
  if (!localStorage.getItem("petpal_favorites")) {
    localStorage.setItem("petpal_favorites", JSON.stringify(["1", "2"]))
  }
}
