...
import ChatWithShelterScreen from "./src/screens/ChatWithShelterScreen"
      ...
      <AuthProvider>
        <NavigationContainer>
          ...
          <Stack.Navigator initialRouteName="Landing" screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen 
              name="ChatWithShelter" 
              component={ChatWithShelterScreen} 
              options={{ headerShown: false, title: "Chat with Shelter" }} 
            />
          </Stack.Navigator>
        </NavigationContainer>
      </AuthProvider>
